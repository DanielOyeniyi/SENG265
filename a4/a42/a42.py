...
def main():
    config: PyArtConfig = PyArtConfig(['CIRCLE', 'RECTANGLE', 'ELLIPSE'], NumberRange(0,500), NumberRange(0,300),
                          NumberRange(0,100), NumberRange(10,30), NumberRange(10,30),
                          NumberRange(10,100), NumberRange(10,100), NumberRange(10,255),
                          NumberRange(10,255), NumberRange(10,255), NumberRange(0,1.0))
    gen_random_table(config, 10)
